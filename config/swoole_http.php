...
return [
    ...
    */
    'resetters' => [
        MuCTS\Http\Server\Resetters\ResetConfig::class,
        MuCTS\Http\Server\Resetters\ResetSession::class,
        MuCTS\Http\Server\Resetters\ResetCookie::class,
        MuCTS\Http\Server\Resetters\ClearInstances::class,
        MuCTS\Http\Server\Resetters\BindRequest::class,
        MuCTS\Http\Server\Resetters\RebindKernelContainer::class,
        MuCTS\Http\Server\Resetters\RebindRouterContainer::class,
        MuCTS\Http\Server\Resetters\RebindViewContainer::class,
        MuCTS\Http\Server\Resetters\ResetProviders::class,
    ],
