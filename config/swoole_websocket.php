...
return [
    ...
    |--------------------------------------------------------------------------
    */
    'handler' => MuCTS\Http\Websocket\SocketIO\WebsocketHandler::class,
    ...
    |--------------------------------------------------------------------------
    */
    'parser' => MuCTS\Http\Websocket\SocketIO\SocketIOParser::class,
    ...
    */
    'middleware' => [
        // MuCTS\Http\Websocket\Middleware\DecryptCookies::class,
        // MuCTS\Http\Websocket\Middleware\StartSession::class,
        // MuCTS\Http\Websocket\Middleware\Authenticate::class,
    ],
    ...
    */
    'handshake' => [
        'enabled' => false,
        'handler' => MuCTS\Http\Websocket\HandShakeHandler::class,
    ],
    ...
    */
    'drivers' => [
        'table' => MuCTS\Http\Websocket\Rooms\TableRoom::class,
        'redis' => MuCTS\Http\Websocket\Rooms\RedisRoom::class,
    ],
